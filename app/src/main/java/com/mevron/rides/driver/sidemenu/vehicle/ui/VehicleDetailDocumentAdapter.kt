...
class VehicleDetailDocumentAdapter(val sel: SelectVehicleDetailDocument, val context: Context, val id: String) :
    ListAdapter<Document, VehicleDetailDocumentAdapter.VehiHolder>(
    ...
    override fun onBindViewHolder(holder: VehiHolder, position: Int) {
        ...
        holder.binding.root.setOnClickListener {
            sel.selectVehicleDocument(doc, id)
        }
    }
...
interface SelectVehicleDetailDocument {
    fun selectVehicleDocument(document: Document, id: String)
}

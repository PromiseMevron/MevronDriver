...
import com.mevron.rides.driver.databinding.FragmentInsuranceBinding
...
class InsuranceFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        isUpdateStatus = InsuranceFragmentArgs.fromBundle(requireArguments()).isUpdateStatus
        uuid = InsuranceFragmentArgs.fromBundle(requireArguments()).id
    ...
    fun uploadData() {
        ...
        viewModel.uploadInsurance(body, uuid).observe(viewLifecycleOwner, Observer {
                ...
                when (res) {
                    ...
                    is GenericStatus.Success -> {
                        ...
                        if (isUpdateStatus) {
                            ...
                            val action =
                                DocumentFragmentDirections.actionGlobalStickerFragment(false, uuid)

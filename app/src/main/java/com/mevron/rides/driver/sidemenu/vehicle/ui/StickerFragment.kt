...
class StickerFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        isUpdateStatus = StickerFragmentArgs.fromBundle(requireArguments()).isUpdateStatus
        uuid = StickerFragmentArgs.fromBundle(requireArguments()).id
    ...
    fun uploadData() {
        ...
        viewModel.uploadSticker(body, uuid).observe(viewLifecycleOwner, Observer {

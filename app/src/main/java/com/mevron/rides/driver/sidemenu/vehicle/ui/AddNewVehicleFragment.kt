...
import com.mevron.rides.driver.databinding.FragmentAddNewVehicleBinding
import com.mevron.rides.driver.sidemenu.vehicle.ui.state.AddNewVehicleState
import com.mevron.rides.driver.updateprofile.ui.AddVehicleFragmentArgs
import com.mevron.rides.driver.updateprofile.ui.adapters.*
...
@AndroidEntryPoint
class AddNewVehicleFragment : Fragment(), CarMakeSelectionListener, CarModelSelectionListener,
    CarYearSelectedListener, ColorSelectionListener {


    private val addVehicleViewModel: AddNewVehicleViewModel by viewModels()

    private lateinit var binding: FragmentAddNewVehicleBinding
    ...
    override fun onCreateView(
        ...
        binding =
            DataBindingUtil.inflate(inflater, R.layout.fragment_add_new_vehicle, container, false)
        return binding.root
    }
    ...
    private fun handleDataSubmittedSuccess(state: AddNewVehicleState) {
        if (state.isDataSubmitted) {
            val action = AddNewVehicleFragmentDirections.actionGlobalInsuranceFragment(false, state.vehicleId)
    ...
    private fun handleBackClicked(state: AddNewVehicleState) {
    ...
    private fun handleError(state: AddNewVehicleState) {
        when (state.error) {
    ...
    private fun setUpCarYearAdapter(state: AddNewVehicleState) {
        yearAdapter = CarYearAdapter(this)
    ...
    private fun setUpCarModelAdapter(state: AddNewVehicleState) {
        modelAdapter = CarModelAdapter(this)
    ...
    private fun setUpCarMakeAdapter(state: AddNewVehicleState) {
        makeAdapter = CarMakeAdapter(this)
    ...
    private fun setUpBottomSheet(state: AddNewVehicleState) {

...
import com.mevron.rides.driver.databinding.AddEmergencyContactFragmentBinding
...
import com.mevron.rides.driver.sidemenu.emerg.ui.adapter.AddEmergencyAdapter
import com.mevron.rides.driver.sidemenu.emerg.ui.adapter.SaveNumber
...
@AndroidEntryPoint
class AddEmergencyContactFragment : Fragment(), SaveNumber {

    companion object {
        fun newInstance() = AddEmergencyContactFragment()
    }

    private val viewModel: AddEmergencyContactViewModel by viewModels()
    private lateinit var binding: AddEmergencyContactFragmentBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(
            inflater,
            R.layout.add_emergency_contact_fragment,
            container,
            false
        )
        return binding.root
    ...
    override fun addRemoveContact(cnt: Contact) {
       ...
       // adapter = AddEmergencyAdapter(this, positions)

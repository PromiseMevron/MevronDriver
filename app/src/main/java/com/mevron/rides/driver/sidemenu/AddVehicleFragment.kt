...
import com.mevron.rides.driver.databinding.AddVehicleFragment2Binding
...
@AndroidEntryPoint
class AddVehicleFragment : Fragment(), Carselected, CarModelselected, CarYearlselected,
    ColorSlected {
    ...
    private lateinit var binding: AddVehicleFragment2Binding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.add_vehicle_fragment2, container, false)
        return binding.root
    }
            ...
            it.let { res ->
                when(res){
                    ...
                    is  GenericStatus.Success ->{
                        ...
                        prevmodel = model
                        binding.addCarYear.recyclerView.layoutManager = LinearLayoutManager(context,
                            RecyclerView.VERTICAL, false)

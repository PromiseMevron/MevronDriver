...
import com.mevron.rides.driver.databinding.FragmentDocumentBinding
...
class DocumentFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        isUpdateStatus = DocumentFragmentArgs.fromBundle(requireArguments()).isUpdateStatus
                ...
                when (res) {
                    ...
                    is GenericStatus.Success -> {
                        ...
                        if (isUpdateStatus) {
                            ...
                            val action =
                                DocumentFragmentDirections.actionGlobalInsuranceFragment(false, "")

...
import com.mevron.rides.driver.updateprofile.ui.state.CarMakeState
import com.mevron.rides.driver.updateprofile.ui.state.CarModelState
import com.mevron.rides.driver.updateprofile.ui.state.CarYearState
...
/**
 * [AddVehicleViewModel] is the first iteration of refactoring, subsequently, we will need to
 * separate the list states presentation logic to it's unique ViewModel, for example, Vehicle Years
 * will have VehicleYearsViewModel that manages Vehicle Years presentation logic.
 */
@HiltViewModel
class AddVehicleViewModel @Inject constructor(
    ...
    private val mutableState: MutableStateFlow<AddVehicleState> =
        MutableStateFlow(AddVehicleState.DEFAULT)

    val state: StateFlow<AddVehicleState>
        get() = mutableState
    ...
    private fun submitData() {
        ...
        viewModelScope.launch(Dispatchers.IO) {
            ...
            when (useCase(request)) {
                is DomainModel.Success -> {
                    updateState(isDataSubmitted = true)
                }
    ...
    private fun AddVehicleState.buildRequest() = AddVehicleRequest(

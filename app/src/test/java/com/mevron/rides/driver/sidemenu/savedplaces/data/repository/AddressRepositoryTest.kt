...
import com.mevron.rides.driver.auth.model.SuccessXX
import com.mevron.rides.driver.domain.DomainModel
import com.mevron.rides.driver.mockError
import com.mevron.rides.driver.sidemenu.savedplaces.data.model.*
    ...
    fun `when AddressRepository#addAnAddress is invoked - sends api request to save address`(): Unit =
        runBlocking {
            ...
            val responseBody = GeneralResponse(
                success = SuccessXX(status = "ww", message = "eeee")
            )
